...
export default function HomeNavbar() {
  ...
  const navLinks = [
    ...
    { title: "Getting Stated", href: "/dashboard/home/getting-started" },
    { title: "Recent Updates", href: "/dashboard/home/updates" },
    { title: "Announcement", href: "/dashboard/home/announcements" },
  ];

  return (
    <div className="h-32 p-5 header-bg bg-slate-50">
      {/* this header-bg is a function from main.scss for the background I used */}
      <div className="flex space-x-3">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-sm">Er.Studio-GoodDay!</span>
        </div>
      </div>
